...
<div class="row">
	...
	<div class="col-sm-8">
		...
		<p><?php /* Afficher un message ici si l'inscription a réussi ou échoué */ ?></p>

		<form class="mt-4" action="api/signup.php" method="post">
			...
			<div class="form-group row text-right">
				<label for="password" class="col-sm-6 col-form-label">Mot de passe (au moins 8 caractères)</label>
				<div class="col-sm-5">
					<input type="password" class="form-control" id="password" name="password">
				</div>
			</div>
			<div class="form-group row text-right">
				<label for="password2" class="col-sm-6 col-form-label">Réécrivez le même mot de passe</label>
				<div class="col-sm-5">
